    ...
    public String getOrders(List<Order> data) {
        ...
        for (Order order : data) {
            sb.append("<tr><td>")
                    ...
                    .append("</form>")
                    .append("<form action=\"FrontController\" method=\"post\">")
                    .append("<button type=\"submit\" name=\"submit\" value=\"Delete Order\" class=\"btn btn-danger\"><i class=\"far fa-trash-alt\"></i></button>\n")
                    .append("<input type=\"hidden\" name=\"command\" value=\"UpdateOrder\">")
                    .append("<input type=\"hidden\" name=\"OrderID\" value=\"")
                    .append(order.getOrderID())
                    .append("\">")
                    .append("</form>")
